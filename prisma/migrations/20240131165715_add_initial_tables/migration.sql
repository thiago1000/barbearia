/*
  ...
  - You are about to drop the column `useId` on the `Booking` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Booking" DROP CONSTRAINT "Booking_useId_fkey";
